...
kubectl delete ns drain-lab --ignore-not-found --wait=false >/dev/null 2>&1
for i in $(seq 1 20); do kubectl get ns drain-lab >/dev/null 2>&1 || break; sleep 2; done
kubectl create ns drain-lab >/dev/null 2>&1
